...
const LoadingScreen=lazy(()=>import('../components/LoadingComponent').then(module=>({default:module.LoadingScreen})));
...
function RegistrationForm() {
  ...
  return (
    <div  ref={formRef} className="primary-p min-h-screen flex items-center justify-center relative overflow-hidden  bg-gradient-to-br from-primary via-gray-900 to-black flex-col">
       <h1 className="text-2xl font-bold text-center mb-10">🎮 3D Object Viewer Login</h1>
...
function LoginForm() {
 ...
 const {navigate}=useReactHooks();
  ...
  return (
    <div ref={formRef} className="min-h-screen flex items-center primary-p justify-center relative overflow-hidden bg-gradient-to-br from-primary via-gray-900 to-black flex-col gap-2">
       <h1 className="text-2xl font-bold text-center mb-10">🎮 3D Object Viewer Login</h1>
       <div className="absolute text-slate-200 inset-0 z-0 pointer-events-none overflow-hidden">
          {stars.map((star, i) => (
            <motion.div
